...
export default function Sidebar({
  ...
  return (
    <div
      className={`w-96 bg-white dark:bg-zinc-800 shadow-[-2px_0_8px_rgba(0,0,0,0.1)] dark:shadow-[-2px_0_8px_rgba(0,0,0,0.3)] overflow-y-auto p-6 transition-transform duration-300 ease-in-out relative z-[5] ${
        isHidden ? "translate-x-full absolute right-0 h-full" : ""
      }`}
    >
      <button
